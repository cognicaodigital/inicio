    ...
    <div className="container-cd pt-20 pb-8">
      <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-12 mb-16">
        ...
        <div>
          ...
          <p style={{fontSize:'0.825rem',color:'rgba(255,255,255,0.6)',lineHeight:'1.8',letterSpacing:'0.01em',marginBottom:'1.5rem'}}>
            Arquitetura e Estruturação de Ecossistemas Digitais de Alta Performance
          </p>
          <div className="flex gap-2.5">
            {[
              [Instagram,'https://instagram.com/cognicao.digital'],
              [Mail,`mailto:${content.company.contact.email}`],
              [Phone,`tel:${(content.company.contact.whatsapp||'').replace(/\D/g,'')}`],
              [Linkedin,'https://linkedin.com/in/cognicaodigital'],
            ].map(([Icon, href], i) => (
              <a key={i} href={href} target={href.startsWith('http')?'_blank':undefined} rel="noopener noreferrer"
                className="w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 hover:scale-110"
                style={{background:'rgba(201,168,76,0.1)',border:'1px solid rgba(201,168,76,0.2)',color:'rgba(255,255,255,0.6)'}}
        ...
        {/* Col 2 — Nav */}
        <div>
          <h4 style={{fontSize:'0.6rem',fontWeight:800,letterSpacing:'0.25em',textTransform:'uppercase',color:'#C9A84C',marginBottom:'1.5rem'}}>NAVEGAÇÃO</h4>
          <ul style={{listStyle:'none',display:'flex',flexDirection:'column',gap:'0.9rem'}}>
            {content.navigation.map(link => (
              <li key={link.path}>
                {link.name==='Mapa de Escala'
                  ? <a href={link.path} style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
                  ...
                  : <Link to={link.path} style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
        ...
        <div>
          <h4 style={{fontSize:'0.6rem',fontWeight:800,letterSpacing:'0.25em',textTransform:'uppercase',color:'#C9A84C',marginBottom:'1.5rem'}}>ESPECIALIDADES</h4>
          <ul style={{listStyle:'none',display:'flex',flexDirection:'column',gap:'0.9rem'}}>
            {especialidades.map((item,i) => (
              <li key={i} className="group relative flex items-start gap-2.5" style={{cursor:'help'}}>
                ...
                <span style={{fontSize:'0.8rem',fontWeight:500,color:'rgba(255,255,255,0.6)',lineHeight:'1.5',letterSpacing:'0.01em',transition:'color 0.3s'}}
        ...
        {/* Col 4 — Academia */}
        <div>
          <h4 style={{fontSize:'0.6rem',fontWeight:800,letterSpacing:'0.25em',textTransform:'uppercase',color:'#C9A84C',marginBottom:'1.5rem'}}>ACADEMIA</h4>
          <ul style={{listStyle:'none',display:'flex',flexDirection:'column',gap:'0.9rem'}}>
            <li>
              <Link to="/academia" style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
            ...
            <li>
              <Link to="/academia#cursos" style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
            ...
            <li>
              <Link to="/academia#trilhas" style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
            ...
            <li>
              <Link to="/academia#conteudos" style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
            ...
            <li>
              <Link to="/area-do-aluno" style={{fontSize:'0.825rem',fontWeight:500,color:'rgba(255,255,255,0.6)',textDecoration:'none',letterSpacing:'0.01em',transition:'color 0.3s'}}
        ...
        {/* Col 5 — Info */}
        <div>
          <h4 style={{fontSize:'0.6rem',fontWeight:800,letterSpacing:'0.25em',textTransform:'uppercase',color:'#C9A84C',marginBottom:'1.5rem'}}>INFORMAÇÕES</h4>
          <div style={{display:'flex',flexDirection:'column',gap:'1.5rem'}}>
            <div style={{display:'flex',gap:'0.75rem'}}>
              ...
              <div>
                ...
                <div style={{fontSize:'0.8rem',color:'rgba(255,255,255,0.6)',lineHeight:'1.7',letterSpacing:'0.01em'}}>Seg a Sex: 10h às 16h<br/>(Sáb, Dom e Fer: Fechado)</div>
              </div>
            </div>
            <div style={{display:'flex',gap:'0.75rem'}}>
              ...
              <div>
                ...
                <div style={{fontSize:'0.8rem',color:'rgba(255,255,255,0.6)',lineHeight:'1.7',letterSpacing:'0.01em'}}>Goiânia - GO<br/>(Atendimento Nacional)</div>
              </div>
            </div>
            <div style={{display:'flex',gap:'0.5rem',flexWrap:'wrap'}}>
              {/* DNA ESTRATÉGICO Badge */}
              <div className="group relative cursor-help" style={{display:'inline-flex',alignItems:'center',gap:'0.35rem',fontSize:'0.55rem',fontWeight:800,letterSpacing:'0.15em',textTransform:'uppercase',padding:'0.35rem 0.85rem',borderRadius:'999px',background:'rgba(201,168,76,0.08)',border:'1px solid rgba(201,168,76,0.2)',color:'#C9A84C'}}>
                DNA ESTRATÉGICO
      ...
      <div style={{paddingTop:'1.5rem',borderTop:'1px solid rgba(255,255,255,0.08)',display:'flex',flexWrap:'wrap',gap:'1rem',alignItems:'center',justifyContent:'space-between'}}>
        <div style={{fontSize:'0.6rem',fontWeight:700,letterSpacing:'0.18em',textTransform:'uppercase',color:'rgba(255,255,255,0.4)'}}>
          © {new Date().getFullYear()} COGNIÇÃO DIGITAL. TODOS OS DIREITOS RESERVADOS.
          {' '}|{' '}
          <Link to="/privacidade" style={{color:'rgba(255,255,255,0.4)',textDecoration:'none',transition:'color 0.3s'}} onMouseEnter={e=>e.currentTarget.style.color='#C9A84C'} onMouseLeave={e=>e.currentTarget.style.color='rgba(255,255,255,0.4)'}>Política de Privacidade</Link>
          {' '}|{' '}
          <Link to="/termos" style={{color:'rgba(255,255,255,0.4)',textDecoration:'none',transition:'color 0.3s'}} onMouseEnter={e=>e.currentTarget.style.color='#C9A84C'} onMouseLeave={e=>e.currentTarget.style.color='rgba(255,255,255,0.4)'}>Termos de Uso</Link>
        </div>
        <div style={{display:'flex',gap:'1rem',alignItems:'center'}}>
          <span style={{fontSize:'0.6rem',fontWeight:800,letterSpacing:'0.2em',textTransform:'uppercase',color:'#C9A84C'}}>ATENDIMENTO NACIONAL</span>
          <span style={{fontSize:'0.6rem',fontWeight:700,letterSpacing:'0.15em',textTransform:'uppercase',color:'rgba(255,255,255,0.4)'}}>CNPJ: 42.457.834/0001-70</span>
        </div>
      </div>
    </div>
  </footer>
