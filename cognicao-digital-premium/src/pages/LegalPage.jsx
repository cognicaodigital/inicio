...
const PrivacyContent = () => (
  <div className="space-y-8 text-slate-400 font-medium leading-relaxed">
    <p>A <strong className="text-white">Cognição Digital</strong> valoriza a sua privacidade. Esta Política de Privacidade descreve como coletamos, usamos, armazenamos e protegemos suas informações pessoais quando você interage com nosso ecossistema.</p>
    ...
    <h3 className="text-xl font-bold text-white">2. Uso das Informações</h3>
    ...
    <h3 className="text-xl font-bold text-white">3. Compartilhamento e Exclusão</h3>
    ...
    <h3 className="text-xl font-bold text-white">4. Segurança e Blindagem</h3>
...
const TermsContent = () => (
  <div className="space-y-8 text-slate-400 font-medium leading-relaxed">
    <p>Estes Termos de Uso regem o acesso e a utilização dos domínios oficiais e propriedades operadas pela <strong className="text-white">Cognição Digital</strong>. Ao acessar nossa plataforma, você concorda legalmente em aderir rigorosamente a estes termos estabelecidos.</p>
    
    <h3 className="text-xl font-bold text-white">1. Direitos de Propriedade Intelectual</h3>
    <p>Todo o conteúdo contido nesta aplicação (textos informativos, identidade visual, logotipo, arquitetura, design thinking e metodologias - como o Método DNA) constitui patrimônio intelectual exclusivo da Cognição Digital, sob a total e intransferível proteção das Leis de Direitos Autorais e Propriedade Intelectual brasileiras vinculadas.</p>

    <h3 className="text-xl font-bold text-white">2. Uso Inadequado</h3>
    ...
    <h3 className="text-xl font-bold text-white">3. Desempenho e Contratos</h3>
    ...
    <h3 className="text-xl font-bold text-white">4. Foro Responsável</h3>
...
const LegalPage = ({ type }) => {
  ...
  usePageSEO(title, `${title} oficial e termos legais da Cognição Digital.`);

  return (
    <div className="pt-32 pb-24 bg-brand-navy text-slate-300 min-h-[75vh]">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Voltar Button */}
        <button 
          onClick={() => navigate(-1)}
          className="mb-12 inline-flex items-center text-xs font-black tracking-widest text-slate-500 hover:text-white uppercase transition-colors group"
        >
          <div className="w-8 h-8 rounded-full border border-white/10 group-hover:border-white/30 flex items-center justify-center mr-4 transition-colors">
        ...
        {/* Header */}
        <div className="mb-16">
          <div className="w-16 h-1 bg-brand-electric rounded-full mb-8"></div>
          <h1 className="text-4xl lg:text-5xl font-black text-white mb-4 tracking-wide">
            {title}
          </h1>
